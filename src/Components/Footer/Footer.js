        ...
        <div className="footer">
            ...
            <div className="footer2">
                ...
                <div className="footer2-sec2">
                    ...
                    <p>Sales : <a href="mailto:sales@vcreatek.com">sales@vcreatek.com</a></p>
                    <p>General info : <a href="mailto:info@vcreatek.com">info@vcreatek.com</a></p>
                    <p>Careers : <a href="mailto:careers@vcreatek.com">careers@vcreatek.com</a></p>
                </div>
            ...
            <p className="copyright">Copyright 2020 by vCreaTek LLC All Right Reserved.</p>
        </div>
    )
}
